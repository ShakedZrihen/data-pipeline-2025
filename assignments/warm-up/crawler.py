...
class Crawler:
    ...
    @staticmethod
    def extract_article_data(elems):
        """
        extracts title, description, date and image from the lady gaga google search page.
        """
        articles = []
    ...
    def save_articles(articles):
        """
        Saves the articles to a .json format
        """
    ...
    def crawl(self):
        ...
        try:
            ...
            articles = self.extract_article_data(elems=elems)
            self.save_articles(articles=articles)
