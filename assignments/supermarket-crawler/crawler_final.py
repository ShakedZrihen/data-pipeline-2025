...
class UniversalSupermarketCrawler:
    ...
    def __init__(self, bucket_name: str, config_file: str | None = None):
    ...
    # ──────────────────────────────────────────────────────────
    def wait_for_gz_links(self, driver, timeout=12):
        try:
    ...
    def crawl_supermarket(self, driver, supermarket):
        ...
        got_links = self.wait_for_gz_links(driver, timeout=10)
        if not got_links:
